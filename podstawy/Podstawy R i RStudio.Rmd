...
Poniższy segment jest nazywany code chunk. Pliki R markdown składają się z nagłówka, segmentów tekstu i specjalnie oznaczonych segmentów kodu. Skrypty składają się z kodu i komantarzy poprzedzonych #.
