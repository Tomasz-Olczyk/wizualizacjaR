...
Zaminiem napisy na daty funkcja as.Date:
...
Dla uniknięcia problemów z rysowaniem linii można uzupełnić końcową komórkę w zmiennej end datą systemową:
...
ggplot(premierzyIIIRP) +
  geom_segment(aes(y = reorder(stronnictwo, start), 
                   ...
                   yend = stronnictwo, 
                   colour = stronnictwo)) +
  scale_x_date(breaks = (premierzyIIIRP$end), 
               date_labels = "%Y") +
  theme_bw() +
  guides(colour = "none")
...
## Kalendarz-mapacieplna z wykorzystaniem geom_tile i facet_wrap
